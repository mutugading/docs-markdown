...
if ($CYL_LEFT_NO_S===""){$CYL_LEFT_NO_S = "NULL";}
...
$SqlView = "SELECT  CMY_NAME
  ...
  if ( $CUSTOMER_S !=="NULL"){
    $SqlViewWhere = "$SqlViewWhere and CYL_SYS_ID in (
          select distinct CYL_SYS_ID  from mgtapps.CST_YARN_LEFT_CUST lc,mgtapps.CST_YARN_LEFT l,mgtapps.CST_MST_CUST_DATA cd
