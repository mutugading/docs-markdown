<?php
	...
	$posDt = strpos($PERIOD_DATA_S,"-");
	$yearPrs = substr($PERIOD_DATA_S,0,$posDt);
	$monthPrs = substr($PERIOD_DATA_S,$posDt+1);
	//echo "posDt $posDt : yearPrs $yearPrs : monthPrs $monthPrs";die();
	...
	//if ($USER_NAME==="1949")	{
		//echo "P_CYL_SYS_ID_DTL $P_CYL_SYS_ID_DTL : deepMaterial $totRM : StsRM $StsRM</br>";//die();
	//}
