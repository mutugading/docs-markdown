<script type='text/javascript'>
	...
	function getParameter(){
		if (document.getElementById('CYL_TYPE')!==null ) {
        	...
        	CYL_TYPE_V = CYL_TYPE.options[CYL_TYPE.selectedIndex].value;
        	CYL_TYPE_T = CYL_TYPE.options[CYL_TYPE.selectedIndex].text;
        	document.getElementById('CYL_TYPE_S').value = CYL_TYPE_V;
    	}
		if (document.getElementById('CYL_SHADE_CODE')!==null ) {
        	CYL_SHADE_CODE = document.getElementById('CYL_SHADE_CODE');
        	CYL_SHADE_CODE_V = CYL_SHADE_CODE.options[CYL_SHADE_CODE.selectedIndex].value;
        	CYL_SHADE_CODE_T = CYL_SHADE_CODE.options[CYL_SHADE_CODE.selectedIndex].text;
        	document.getElementById('CYL_SHADE_CODE_S').value = CYL_SHADE_CODE_V;
    	}
    	if (document.getElementById('CYL_SHADE_NAME')!==null ) {
        	CYL_SHADE_NAME = document.getElementById('CYL_SHADE_NAME');
        	CYL_SHADE_NAME_V = CYL_SHADE_NAME.options[CYL_SHADE_NAME.selectedIndex].value;
        	CYL_SHADE_NAME_T = CYL_SHADE_NAME.options[CYL_SHADE_NAME.selectedIndex].text;
        	document.getElementById('CYL_SHADE_NAME_S').value = CYL_SHADE_NAME_V;
    	}
    	if (document.getElementById('CMY_LUSTURE')!==null ) {
        	CMY_LUSTURE = document.getElementById('CMY_LUSTURE');
        	CMY_LUSTURE_S_V = CMY_LUSTURE.options[CMY_LUSTURE.selectedIndex].value;
        	CMY_LUSTURE_S_T = CMY_LUSTURE.options[CMY_LUSTURE.selectedIndex].text;
        	document.getElementById('CMY_LUSTURE_S').value = CMY_LUSTURE_S_V;
    	}
    	if (document.getElementById('DENIER')!==null ) {
        	DENIER = document.getElementById('DENIER');
        	DENIER_S_V = DENIER.options[DENIER.selectedIndex].value;
        	DENIER_S_T = DENIER.options[DENIER.selectedIndex].text;
        	document.getElementById('DENIER_S').value = DENIER_S_V;
    	}
    	if (document.getElementById('FILAMENT')!==null ) {
        	FILAMENT = document.getElementById('FILAMENT');
        	FILAMENT_S_V = FILAMENT.options[FILAMENT.selectedIndex].value;
        	FILAMENT_S_T = FILAMENT.options[FILAMENT.selectedIndex].text;
        	document.getElementById('FILAMENT_S').value = FILAMENT_S_V;
    	}
    	if (document.getElementById('INTERMINGLING')!==null ) {
        	INTERMINGLING = document.getElementById('INTERMINGLING');
        	INTERMINGLING_S_V = INTERMINGLING.options[INTERMINGLING.selectedIndex].value;
        	INTERMINGLING_S_T = INTERMINGLING.options[INTERMINGLING.selectedIndex].text;
        	document.getElementById('INTERMINGLING_S').value = INTERMINGLING_S_V;
    	}
    	if (document.getElementById('CROSS_SECTION')!==null ) {
        	CROSS_SECTION = document.getElementById('CROSS_SECTION');
        	CROSS_SECTION_S_V = CROSS_SECTION.options[CROSS_SECTION.selectedIndex].value;
        	CROSS_SECTION_S_T = CROSS_SECTION.options[CROSS_SECTION.selectedIndex].text;
        	document.getElementById('CROSS_SECTION_S').value = CROSS_SECTION_S_V;
    	}
    	if (document.getElementById('CUSTOMER')!==null ) {
        	CUSTOMER = document.getElementById('CUSTOMER');
        	CUSTOMER_S_V = CUSTOMER.options[CUSTOMER.selectedIndex].value;
        	CUSTOMER_S_T = CUSTOMER.options[CUSTOMER.selectedIndex].text;
        	document.getElementById('CUSTOMER_S').value = CUSTOMER_S_V;
    	}
    	if (document.getElementById('HEATSET')!==null ) {
        	HEATSET = document.getElementById('HEATSET');
        	HEATSET_S_V = HEATSET.options[HEATSET.selectedIndex].value;
        	HEATSET_S_T = HEATSET.options[HEATSET.selectedIndex].text;
        	document.getElementById('HEATSET_S').value = HEATSET_S_V;
    	}

			if (document.getElementById('CYL_LEFT_NO')!==null ) {
					document.getElementById('CYL_LEFT_NO_S').value = document.getElementById('CYL_LEFT_NO').value;
			}
	}
