...
<body onload="<?php if ($firstLoad==="") { echo " Process('VIEW_DATA')"; $firstLoad="Y"; }?>"	>
<?php
...
<input type="hidden" name="firstLoad" id="firstLoad" value="<?php echo $firstLoad; ?>">
