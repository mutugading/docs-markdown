<?php
//echo "P_CYL_SYS_ID_DTL $P_CYL_SYS_ID_DTL MELANGE</br>";
...
<?php
      ...
      if ($row1Data['CYCRL_SEQ_NO']==="6"){
        if ($x < $totRM ){
          $CylSysId_RM = getCylSysIdRMMelangeVal($conn,$P_CYL_SYS_ID_DTL,$x);
      ...
      ?>
          <td align="<?php echo $CYCRL_JUSTIFY; ?>" >
      <?php
            //echo "check 2 : CylSysId_dt $CylSysId_dt";
            isBold($row1Data['CYCRL_IS_BOLD'],1);
            echo $dtVal;//print value
            isBold($row1Data['CYCRL_IS_BOLD'],2);
      ?>
