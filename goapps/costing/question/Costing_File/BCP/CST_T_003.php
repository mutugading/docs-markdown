...
<?php
  ...
  include("conOraOci.php");
	...
	$CYL_SHADE_NAME_TMP="UNSELECTED";
	if(isset($_POST['CYL_SHADE_NAME_TMP'])) {
		$CYL_SHADE_NAME_TMP=$_POST['CYL_SHADE_NAME_TMP'];
	}
	$CYL_SHADE_NAME_S="UNSELECTED";
	if ($CYL_SHADE_NAME_TMP!=="") {
		$SqlGet	= "SELECT REPLACE (GET_DATA, ',', ''',''') GET_DATA
							 FROM (
								SELECT '(''$CYL_SHADE_NAME_TMP'')' GET_DATA FROM DUAL
							 )";
		$CYL_SHADE_NAME_S =  getData($conn,$SqlGet);
	}
	...
	//echo "STSPRS $STSPRS : CYL_SHADE_NAME_S $CYL_SHADE_NAME_S : CYL_SHADE_NAME_TMP $CYL_SHADE_NAME_TMP</br>";
	...
	if ($P_CYL_SYS_ID_DTL !== ""){
		...
		$MenuPrintHrefXls = $FORM_NAME."_VIEW_XLS?P_FORM_NAME=$FORM_NAME"
							...
							."&CYL_SHADE_NAME_S=$CYL_SHADE_NAME_TMP&CMY_LUSTURE_S=$CMY_LUSTURE_S&DENIER_S=$DENIER_S"
							."&FILAMENT_S=$FILAMENT_S&INTERMINGLING_S=$INTERMINGLING_S&CROSS_SECTION_S=$CROSS_SECTION_S"
							."&HEATSET_S=$HEATSET_S&CUSTOMER_S=$CUSTOMER_S&CYL_LEFT_NO_S=$CYL_LEFT_NO_S";
	}
...
<input type="hidden" name="CYL_SHADE_NAME_S" id="CYL_SHADE_NAME_S" value="<?php echo $CYL_SHADE_NAME_S;  ?>">
<input type="hidden" name="CYL_SHADE_NAME_TMP" id="CYL_SHADE_NAME_TMP" value="<?php echo $CYL_SHADE_NAME_TMP;  ?>">
