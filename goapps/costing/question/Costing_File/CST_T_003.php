...
<?php
  ...
  include("conOraOci.php");
	...
	$CYL_SHADE_NAME_TMP="UNSELECTED"; if(isset($_POST['CYL_SHADE_NAME_TMP'])) {$CYL_SHADE_NAME_TMP=$_POST['CYL_SHADE_NAME_TMP'];}
	$CYL_SHADE_NAME_S="UNSELECTED";if ($CYL_SHADE_NAME_TMP!=="") {
