...
<?php
  ...
  include("../conOraOci.php");
	...
	$byType = "Y"; 	$byShade = "";	$byCust = "";	$byShadeMulti = "";	$CYL_IS_PROJECT_S = "";
	//Get Parameter
	...
	$SQD_CYL_LEFT_NO_DT=""; if(isset($_POST['SQD_CYL_LEFT_NO_DT'])) { $SQD_CYL_LEFT_NO_DT=$_POST['SQD_CYL_LEFT_NO_DT'];}
	//echo "SQD_CYL_LEFT_NO_DT $SQD_CYL_LEFT_NO_DT<br>";
	$SHADE_CHOICE="";	if(isset($_POST['SHADE_CHOICE'])) {$SHADE_CHOICE=$_POST['SHADE_CHOICE'];}

	$CK_ALL_S=""; if(isset($_POST['CK_ALL_S'])) { $CK_ALL_S=$_POST['CK_ALL_S'];}
	//echo "CK_ALL_S $CK_ALL_S<br>";

	$P_PAGE_NO = "";
	if(isset($_POST['P_PAGE_NO'])) {$P_PAGE_NO=$_POST['P_PAGE_NO'];}
...
<?php
	...
	$styleTxt = "font-family:verdana;font-size:33px"; $bgClrLbl = "bgcolor='#F6E3CE'";
?>
...
<div class="main" style="overflow-x:auto;overflow-y:auto;" align="center" onclick="closeNav()">
<!--<div class="main" style="overflow-x:auto;" align="center">-->
<!-- DEFINE LAYOUT -->
<?php
	if ($STSPRS==="ADD_QUOTATION" || $STSPRS==="REMOVE_QUOTATION" || $STSPRS==="GENERATE_QUOTATION"){
		include ($FORM_NAME."_DB.php");
	} else {
		include ("CST_FIND_PRODUCT_CHOICE_VIEW_QUOTATION.php");
	}
...
<input type="hidden" name="CK_ALL_S" id="CK_ALL_S">

<!-- Quotation Process -->
<input type="hidden" name="SQD_CYL_LEFT_NO_DT" id="SQD_CYL_LEFT_NO_DT">
<!-- Quotation Process -->
