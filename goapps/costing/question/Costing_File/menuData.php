...
<div id="mySidenav" class="sidenav" align="left">
  ...
  <div align="center">
    <input type="text" id="searchMenu" placeholder="Find menu..." style="color: white;width: 130px;background-color: black;height: 22px;" onchange="searchMenu()">
    <button type="button" onclick="searchMenu('Y')" style="height: 25px;font-size: : 12px;" data-toggle="tooltip" data-placement="top" title="Expanse">&nbsp+&nbsp</button>
    <button type="button" onclick="resetDropdowns()" style="height: 25px;" data-toggle="tooltip" data-placement="top" title="Collapse">&nbsp-&nbsp</button>
  </div>
<?php
  //Main Menu
...
// Fungsi untuk pencarian menu
function searchMenu(pExpandAll="") {
