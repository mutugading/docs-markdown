...
<table style="width:95%">
	...
	<table style="width:95%" border="1" align="center">
		...
		<tr>
			...
			<td align="center" >
				<input 	type="hidden" id="SMLT_NORM_SPIN_10" name="SMLT_NORM_SPIN_10"
						<?php echo $bgClrEntry; ?>
		...
		<tr>
			...
			<td align="center" >
				<input 	type="hidden" id="SMLT_NORM_SPIN_11" name="SMLT_NORM_SPIN_11"  <?php echo $bgClrEntry; ?>
		...
		<tr>
			...
			<td align="center"  >
				<input 	type="text" id="SMLT_NORM_SPIN_72" name="SMLT_NORM_SPIN_72" <?php echo $bgClrEntry; ?>
						value="<?php echo setDecimal($conn,$SMLT_NORM_SPIN_72_S,3); ?>"
					   	onkeypress="Javascript: if (event.keyCode==13) Process(''); "
				>
			</td><!--8-->
			<td align="center" >
		...
		<tr>
			...
			<td align="center" >
				<input 	type="text" id="SMLT_NORM_SPIN_71" name="SMLT_NORM_SPIN_71" <?php echo $bgClrEntry; ?>
						value="<?php echo setDecimal($conn,$SMLT_NORM_SPIN_71_S,3); ?>"
					   	onkeypress="Javascript: if (event.keyCode==13) Process(''); "
				>
			</td>
			<td align="center" >
			...
			<td align="center" >
				<?php echo setDecimal($conn,$Spin_3_71,3); ?>
			</td>
			<td align="center" >
			</td>
			<td align="center" >
				<?php echo setDecimal($conn,$inc_cost_71,3); ?>
			</td>
		</tr>
		...
		<tr>
			...
			<td align="center" >
				<?php echo setDecimal($conn,$inc_cost_packing,3); ?>
			</td>
		</tr>
		<!-- Total adjustments-->
		<tr>
			...
			<td align="center" >
				<?php echo setDecimal($conn,$inc_cost_tot_adjsmnt,3); ?>
			</td>
		</tr>
		<!-- Data -->
	</table>
...
?>
	...
	<table style="width:60%" border="1">
		<tr >
			...
			<td style="<?php echo $width_V; ?>" align="center">
				VB1
			</td><!-- 2 -->
			<td style="<?php echo $width_V; ?>" align="center">
				VB2
		...
		<tr >
			<td align="center">
				Cost before Simulation
			</td><!-- 1 -->
			<td align="right">
					<?php echo setDecimal($conn,$VB1_1,2); ?>
			</td><!-- 2 -->
			<td align="right">
					<?php echo setDecimal($conn,$VB1_2,2); ?>
			</td><!-- 3 -->
			<td align="right">
					<?php echo setDecimal($conn,$VB1_3,2); ?>
			</td><!-- 4 -->
			<td align="right">
					<?php echo setDecimal($conn,$VB1_4,2); ?>
			</td><!-- 5 -->
			<td align="right">
					<?php echo setDecimal($conn,$VB1_5,2); ?>
			</td><!-- 6 -->
		</tr>
		<tr >
			<td align="center">
			...
			<td align="right">
					<?php echo setDecimal($conn,$VB2_1,2); ?>
			</td><!-- 2 -->
			<td align="right">
					<?php echo setDecimal($conn,$VB2_2,2); ?>
			</td><!-- 3 -->
			<td align="right">
					<?php echo setDecimal($conn,$VB2_3,2); ?>
			</td><!-- 4 -->
			<td align="right">
					<?php echo setDecimal($conn,$VB2_4,2); ?>
			</td><!-- 5 -->
			<td align="right">
					<?php echo setDecimal($conn,$VB2_5,2); ?>
			</td><!-- 6 -->
		</tr>
	</table>
