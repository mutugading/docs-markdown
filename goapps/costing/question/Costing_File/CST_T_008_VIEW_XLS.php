...
$CMY_NAME_S = "NULL";if(isset($_GET['CMY_NAME_S'])){$CMY_NAME_S=$_GET['CMY_NAME_S'];}
// echo "CMY_NAME_S $CMY_NAME_S<br>";
...
$START_ROW="";if(isset($_GET['START_ROW'])){$START_ROW=$_GET['START_ROW'];}
$END_ROW="";if(isset($_GET['END_ROW'])){$END_ROW=$_GET['END_ROW'];}
...
$pStartRow = $START_ROW; $pEndRow = $END_ROW;

$excelNm = "Costing ALL Product Form $pStartRow until $pEndRow .Xls";
header("Content-type: application/vnd-ms-excel");
header("Content-Disposition: attachment; filename=$excelNm");
echo "<table>";
echo "<tr>";
echo "<td>Report : $excelNm </td>";
echo "</tr>";
echo "</table>";
?>
<table>
<?php
  ...
  $SqlView = "$sqlSelect from ($SqlView) d where REC_NO between $pStartRow and $pEndRow ";
...
<tr>
    ...
    <td <?php echo "style='font-size: 18px;background-color:$ClrView24'"; ?> >
      <b><?php echo setNumber($conn,"Number",$valDt24,4); ?></b><!--Chip Rate -->
    </td><!--7-->
