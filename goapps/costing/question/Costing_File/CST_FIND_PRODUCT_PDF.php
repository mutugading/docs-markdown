...
//   echo "isUseRmBo $isUseRmBo";die();
// }

if ($STS_RM_55==="Y"){
  include ("CST_FIND_PRODUCT_PDF_RM_55.php");
} else {

  if ($isUseRmBo==="Y" ){
    include ("CST_FIND_PRODUCT_PDF_USE_RM_BO.php");
    //include("CST_FIND_PRODUCT_VIEW_DETAIL_USE_RM_BO.php");
  } else {

    if ($CYL_TYPE==="ITY"){
      include ("CST_FIND_PRODUCT_PDF_ITY.php");
    }else if ($CYL_TYPE==="ACY"){
      include ("CST_FIND_PRODUCT_PDF_ACY.php");
    } else if ($CYL_TYPE==="MELANGE"){
      include ("CST_FIND_PRODUCT_PDF_MELANGE.php");
    } else if ($CYL_TYPE==="PTY BO" ){
      include ("CST_FIND_PRODUCT_PDF_PTY_BO.php");
    } else {
