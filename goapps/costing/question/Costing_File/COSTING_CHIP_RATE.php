...
if ($totRm_Poy>1){
  ...
  // if ($USER_NAME==="1949"){echo "totRm_Poy $totRm_Poy : CK_CYL_TYPE $CK_CYL_TYPE<br>";}
  $isMelangePrs="";
  ...
  if ($isMelangePrs==="Y"){
    ...
    $SqlMbDt =
      ...
      // if ($USER_NAME==="1949"){ echo "Cek RM_PTY_BO $RM_PTY_BO<br>"; }
      if ($RM_PTY_BO !=="" ){
    ...
    if ($CK_CYL_TYPE==="ACY"){
      ...
      // if ($USER_NAME==="1949"){ echo "selain ACY : ckDtStr $ckDtStr"; }
      if ($ckDtStr==="Y"){
