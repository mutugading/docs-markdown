...
<!-- Shade Name - Code -->
		<td align="center">
<?php
	if ($CYL_SHADE_NAME_TMP==="UNSELECTED") {
		echo "<b>Shade Name </b></br>";
		...
		oci_execute ($rsSlct);
?>
		<select name="CYL_SHADE_NAME" id="CYL_SHADE_NAME" <?php echo $styleSlct; ?> multiple
<?php
...
if ($CYL_SHADE_NAME_TMP!=="UNSELECTED") {
	echo "<b><font color='red'>Shade Name</font> in <font color='blue'>$CYL_SHADE_NAME_S</font></b></br>";
}

	if ($CYL_SHADE_NAME_TMP==="UNSELECTED"){
?>
			<input type="button" class="button btn_process" onclick="Process('VIEW_DATA')" value="Process">
<?php
	} else {
?>
			<input type="button" class="button btn_clear" onclick="Process('CLEAR_PARAM')" value="Clear">
<?php
	}
?>
	</td>
